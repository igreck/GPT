...
def main():
    ...
    # === Policy model (QLoRA): resume -> from_pretrained; altfel SFT dir sau LoRA nouă ===
    if getattr(cfg, "resume_dir", None):
        ...
        policy_model = PPOQLoRAWithValueHead(
            ...
            device_map="auto",
            lora_from_sft_dir=sft_dir,             # None => LoRA nouă
    ...
    out_dir = os.path.join(getattr(cfg, "save_dir", "rl_imdb_qlora_qwen"), "checkpoint_last")
